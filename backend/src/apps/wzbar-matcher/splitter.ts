...
- **Verschiedene Wirtschaftsformen sind DISTINKTE Tätigkeiten** — auch beim selben Produkt: Herstellung, Handel/Vertrieb, Handelsvermittlung, Reparatur und Vermietung liegen in der WZ in verschiedenen Bereichen. "Produktion von Spielwaren und Handel mit Spielwaren" → zwei Tätigkeiten ("Herstellung von Spielwaren", "Handel mit Spielwaren"); "Herstellung und Vertrieb von Möbeln" → zwei Tätigkeiten. Die vorige Regel verbietet nur das Abtrennen einer Form von ihrem Produkt — nicht die Trennung zweier Formen voneinander.
