...
const NEIGHBORHOOD_NODE_SCHEMA: JsonSchema = {
  ...
  properties: {
    ...
    kurztext: { type: 'string' },
    langtext: { type: 'string' },
    level: { type: 'integer', minimum: 4, maximum: 7, description: 'Hierarchie-Ebene (4=Klasse, 5=Unterklasse, 6/7=nationale Detail-Unterklasse).' },
    indent: { type: 'integer', minimum: 0, maximum: 3, description: 'Einrueckung relativ zur Klasse (level - 4).' },
