...
async function runDelegatedAgent(
  ...
  while (iteration < maxIterations) {
    ...
    for (const toolCall of toolCalls) {
      ...
      if (toolName === 'generate_image' || toolName === 'edit_image' || toolName === 'export_document' || toolName === 'fill_template_to_docx') {
        try {
...
export async function* runAgentLoop(
  ...
  try {
    ...
    synthSystemPrompt = appendSkillInstructions(synthSystemPrompt, loopState.loadedSkillInstructions);
