...
mock.module("../utils/paths", () => ({
  ...
  PROVIDERS_CONFIG: "/tmp/spaces-test-data/config/providers.yaml",
  ...
  PLUGINS_DIR: "/tmp/spaces-test-data/plugins",
  PLUGINS_CONFIGS_DIR: "/tmp/spaces-test-data/config/plugins",
  PLUGINS_INSTALLED_DIR: "/tmp/spaces-test-data/plugins/installed",
  PLUGINS_REGISTRY_FILE: "/tmp/spaces-test-data/plugins/registry.yaml",
