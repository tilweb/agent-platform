...
Tools sind die Schnittstelle zwischen LLM und externem Dienst. Jedes Tool definiert einen Namen, eine Beschreibung für den LLM, ein Parameter-Schema und eine Execute-Funktion.
